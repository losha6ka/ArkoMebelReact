...
import contactMap from "../../img/contact-map/bg.jpg"

export const Contacts: FC = () => {
    return <section className="main-contact contacts">
        <div className="contacts__container">
            <div className="contacts__contact">
                <div className="contacts__contact-bg"><img src={contactMap} alt="" /></div>
                <h2 className="contacts__contact-title page-title">НАШИ КОНТАКТЫ</h2>
                <div className="contacts__contact-geodan"><a href="https://www.google.com/">Керечевская, Киевская 144 корпус -1</a></div>
